	...
	<div class="row">		
		<div class="col-12">			 
			...
			<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
				...
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link text-light" href="#">자유게시판</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text-light" href="#">자료실</a>
					</li>
					<li class="nav-item">
				...
				<ul class="navbar-nav ml-auto" >
					...
					<li class="nav-item"><!-- 회원가입 -->
						<a class="nav-link text-light" href="#"><i class='fas fa-edit' style='font-size:20px'></i>회원가입</a>
					</li>
					<li class="nav-item"><!-- 로그인 -->
						<a class="nav-link text-light" href="#"><i class='fas fa-sign-in-alt' style='font-size:20px'></i>로그인</a>
					</li>
				
					<li class="nav-item"><!-- 회원정보수정 -->
						<a class="nav-link text-light" href="#"><i class='fa fa-cogs' style='font-size:20px'></i>회원정보수정</a>
					</li>
					<li class="nav-item"><!-- 로그아웃 -->
						<a class="nav-link text-light" href="#"><i class='fas fa-sign-out-alt' style='font-size:20px'></i>로그아웃</a>
					</li> 										
